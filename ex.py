...
def firstLevel():
    ...
    '''
    possi = [   #combinacoes primeira cor
        [forms[0], colors[0] ], [forms[1], colors[0] ], [forms[2], colors[0] ], 
        [forms[3], colors[0] ], [forms[4], colors[0] ], [forms[5], colors[0] ],
                #combinacoes segunda cor
        [forms[0], colors[1] ], [forms[1], colors[1] ], [forms[2], colors[1] ], 
        [forms[3], colors[1] ], [forms[4], colors[1] ], [forms[5], colors[1] ]
        ]
    '''
    ...
    while(x == 1):
        ...
        for event in pygame.event.get():
            ...
            if (mb[0]):
                if (rect11.pos):
                    twoClicks(rect11, rect13)
            

        
        #cria, desenha e define a posicao do rectangulo  ### " rectYX " ###
        rect11 = button(True, green, white, 365, 265, 50, 200, 265, 50, 100, 150, '')
        #aplica a classe geoForm(self, forms, colors, x, y, pos)) ### " formYX " ###
        ...
        #score#
        text = myFont.render("Score:", True, yellow)
